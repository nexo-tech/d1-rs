...
impl Predicate {
    ...
    /// 🚨 REMOVED: String-based field predicate constructor - VIOLATES zero-string-literals policy!
    /// 
    /// This method has been REMOVED to enforce compile-time safety.
    /// Use the type-safe query methods generated by the derive macro instead.
    /// 
    /// **Example of type-safe alternative:**
    /// ```rust
    /// // Instead of: Predicate::field("name", "=", value)  // ❌ Removed!
    /// // Use type-safe methods generated by derive macro:
    /// # use d1_rs::*;
    /// # use serde::{Serialize, Deserialize};
    /// # #[derive(Entity, Serialize, Deserialize, Clone)]
    /// # struct User { id: i64, name: String }
    /// # let value = "John".to_string();
    /// # let query = User::query().where_name_eq(value);  // ✅ Compile-time safe!
    /// ```
    
    /// 🚨 REMOVED: String-based relation predicate constructor - VIOLATES zero-string-literals policy!
    /// 
    /// This method has been REMOVED to enforce compile-time safety.
    /// Use the type-safe relation methods generated by the relations! macro instead.
    /// 
    /// **Example of type-safe alternative:**
    /// ```rust
    /// // Instead of: Predicate::has("posts")  // ❌ Removed!
    /// // Use type-safe relation methods generated by relations! macro:
    /// # use d1_rs::*;
    /// # use serde::{Serialize, Deserialize};
    /// # #[derive(Entity, Serialize, Deserialize, Clone)]
    /// # struct User { id: i64, name: String }
    ...
    /// # let query = User::query(); // .has_posts() - Generated by relations! macro
    /// ```
    
    /// 🚨 REMOVED: String-based relation with condition predicate - VIOLATES zero-string-literals policy!
    /// 
    /// This method has been REMOVED to enforce compile-time safety.
    /// Use the type-safe relation methods generated by the relations! macro instead.
    /// 
    /// **Example of type-safe alternative:**
    /// ```rust
    /// // Instead of: Predicate::has_with("posts", condition)  // ❌ Removed!
    /// // Use type-safe relation methods with conditions:
    /// # use d1_rs::*;
    /// # use serde::{Serialize, Deserialize};
    /// # #[derive(Entity, Serialize, Deserialize, Clone)]
    /// # struct User { id: i64, name: String }
    /// # #[derive(Entity, Serialize, Deserialize, Clone)]
    /// # struct Post { id: i64, user_id: i64, published: bool }
    /// # let query = User::query(); // .has_posts_with(|p| p.where_published_eq(true))
    /// ```
    
    /// INTERNAL USE ONLY: Relation exists predicate for macro-generated methods
    /// 
    /// 🚨 WARNING: This method takes string parameters but is NOT part of the public API!
    /// Users should NEVER call this directly - use type-safe relation methods instead
    /// Relation names come from macro-generated constants (compile-time safe)
    #[doc(hidden)]
    ...
    /// INTERNAL USE ONLY: Relation with conditions predicate for macro-generated methods
    /// 
    /// 🚨 WARNING: This method takes string parameters but is NOT part of the public API!
    /// Users should NEVER call this directly - use type-safe relation methods instead
    /// Relation names come from macro-generated constants (compile-time safe)
...
impl<Parent: Entity, Child: Entity> EagerQueryBuilder<Parent, Child> {
    ...
    /// 🚨 REMOVED: String-based eager loading - VIOLATES zero-string-literals policy!
    /// 
    /// This method has been REMOVED to enforce compile-time safety.
    /// Use the type-safe eager loading methods generated by the relations! macro instead.
    /// 
    /// **Example of type-safe alternatives:**
    /// ```rust
    /// // Instead of: User::query().with_additional::<Post>("posts")  // ❌ Removed!
    /// // Use type-safe eager loading generated by relations! macro:
    /// # use d1_rs::*;
    /// # use serde::{Serialize, Deserialize};
    /// # #[derive(Entity, Serialize, Deserialize, Clone)]
    /// # struct User { id: i64, name: String }
    ...
    /// # struct Post { id: i64, user_id: i64, title: String }
    /// # #[derive(Entity, Serialize, Deserialize, Clone)]
    /// # struct Profile { id: i64, user_id: i64, bio: String }
    /// # let query1 = User::query(); // .with_posts() - Generated by relations! macro
    /// # let query2 = User::query(); // .with_posts().with_profile() - Chaining
    /// ```
