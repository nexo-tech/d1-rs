...
pub fn get_migration_runner() -> MigrationRunner {
    ...
    let create_tokens_migration =
        CreateTableMigration::new("create_tokens", 2, "tokens".to_string())
            .column("id", "INTEGER")
            .primary_key()
    ...
    let create_calendars_migration =
        CreateTableMigration::new("create_calendars", 3, "calendars".to_string())
            .column("id", "INTEGER")
            .primary_key()
            .column("user_id", "INTEGER")
            .not_null()
    ...
    let create_working_hours_migration =
        CreateTableMigration::new("create_working_hours", 4, "working_hours".to_string())
            .column("id", "INTEGER")
            .primary_key()
    ...
    let create_bookings_migration =
        CreateTableMigration::new("create_bookings", 5, "bookings".to_string())
            .column("id", "INTEGER")
            .primary_key()
            .column("calendar_id", "INTEGER")
            .not_null()
            .column("guest_email", "TEXT")
            .not_null()
