...
mod tests {
    ...
    async fn test_data_normalization() {
        ...
        let transformation_type = ColumnTransformationType::Normalization {
            source_pattern: "full_name".to_string(),
            target_fields: vec!["first_name".to_string(), "last_name".to_string()],
            extraction_rules: vec!["SPACE_SPLIT_FIRST".to_string(), "SPACE_SPLIT_LAST".to_string()],
        };
